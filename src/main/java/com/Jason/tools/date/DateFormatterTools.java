...
public class DateFormatterTools
{
    ...
    public static String formatDate(Date date,String format){
        return formatDate(DateTools.date2String(date), format);
    }
    ...
    public static String formatDate(String value){
        return getFormat(DATE_FORMAT2).format(DateTools.string2Date(value, DATE_FORMAT2));
    }
    ...
    public static String formatDate(Date value){
        return formatDate(DateTools.date2String(value));
    }
