...
public class DateTools {
    ...
    public static String getCurrentTime(String format){
        SimpleDateFormat sdf = DateFormatterTools.getFormat(format);
        Date date = new Date();
    ...
    public static String getCurrentTime(){
        return getCurrentTime(DateFormatterTools.DATE_FORMAT2);
    }
    ...
    public static Date getCurrentDate(){
        return getCurrentDate(DateFormatterTools.DATE_FORMAT2);
    }
    ...
    public static Date string2Date(String value){
        ...
        SimpleDateFormat sdf = DateFormatterTools.getFormat(DateFormatterTools.DATE_FORMAT2);
        Date date = null;

        try {
            value = DateFormatterTools.formatDate(value, DateFormatterTools.DATE_FORMAT2);
    ...
    public static Date string2Date(String value,String format){
        ...
        try {
            value = DateFormatterTools.formatDate(value, format);
            date = sdf.parse(value);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static int getCurrentYear(Date value){
        String date = date2String(value, DateFormatterTools.DATE_YEAR);
    ...
    public static int getCurrentYear(String value) {
        Date date = string2Date(value, DateFormatterTools.DATE_YEAR);
        Calendar calendar = getCalendar(date, DateFormatterTools.DATE_YEAR);
    ...
    public static int getCurrentMonth(Date value){
        String date = date2String(value, DateFormatterTools.DATE_MONTH);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentMonth(String value) {
        Date date = string2Date(value, DateFormatterTools.DATE_MONTH);
        Calendar calendar = getCalendar(date, DateFormatterTools.DATE_MONTH);
    ...
    public static int getCurrentDay(Date value){
        String date = date2String(value, DateFormatterTools.DATE_DAY);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentDay(String value){
        Date date = string2Date(value, DateFormatterTools.DATE_DAY);
        Calendar calendar = getCalendar(date, DateFormatterTools.DATE_DAY);
    ...
    public static String getCurrentWeek(Date value) {
        Calendar calendar = getCalendar(value, DateFormatterTools.DATE_FORMAT1);
    ...
    public static String getCurrentWeek(String value) {
        Date date = string2Date(value, DateFormatterTools.DATE_FORMAT1);
    ...
    public static int getCurrentHour(Date value){
        String date = date2String(value, DateFormatterTools.DATE_HOUR);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentHour(String value) {
        Date date = string2Date(value, DateFormatterTools.DATE_HOUR);
        Calendar calendar = getCalendar(date, DateFormatterTools.DATE_HOUR);
    ...
    public static int getCurrentMinute(Date value){
        String date = date2String(value, DateFormatterTools.DATE_MINUTE);
        return Integer.valueOf(date);
    }
    ...
    public static int getCurrentMinute(String value){
        Date date = string2Date(value, DateFormatterTools.DATE_MINUTE);
        Calendar calendar = getCalendar(date, DateFormatterTools.DATE_MINUTE);
    ...
    public static int compareDate(String startDay,String endDay,int stype) {
        int n = 0;
        startDay = DateFormatterTools.formatDate(startDay, "yyyy-MM-dd");
        endDay = DateFormatterTools.formatDate(endDay, "yyyy-MM-dd");
    ...
    public static int compareTime(String startTime , String endTime , int type) {
        ...
        SimpleDateFormat sdf = DateFormatterTools.getFormat("");
        int value = 0;
        try {
    ...
    public static int compare(String date1, String date2,String format) {
        DateFormat df = DateFormatterTools.getFormat(format);
        try {
    ...
    public static String getMonthFirstDate(String date){
        date = DateFormatterTools.formatDate(date);
        return DateFormatterTools.formatDate(date, "yyyy-MM") + "-01";
    }
    ...
    public static String getMonthLastDate(String date) {
        ...
        return DateFormatterTools.formatDate(calendar.getTime());
    }
     ...
     * @return
     */
    public static String getMonthFirstDay(String formatter)
    {
     ...
     * @return
     */
    public static String getMonthLastDay(String formatter)
    {
        SimpleDateFormat format = new SimpleDateFormat(formatter);
        Calendar cale = Calendar.getInstance();
    ...
    {
        SimpleDateFormat sdf=new SimpleDateFormat(DateFormatterTools.DATE_FORMAT1);
     ...
     * 根据传递时间计算与当前日期的年差
     *
     * @param datetime 尽可传递比今天早的日期
     * @return
     */
    public static int getDifferenceReturnYear(Date datetime) {
        int age = 0;
        Calendar born = Calendar.getInstance();
        Calendar now = Calendar.getInstance();
        if (datetime != null) {
            now.setTime(new Date());
            born.setTime(datetime);
            if (born.after(now)) {
                throw new IllegalArgumentException("传递参数不能超过当前日期");
            }
     ...
     * @return
     */
    public static int getDifferenceReturnMonth(Date datetime) {
        int age = 0;
        Calendar born = Calendar.getInstance();
        Calendar now = Calendar.getInstance();
        if (datetime != null) {
            ...
            age = (now.get(Calendar.YEAR) - born
                    .get(Calendar.YEAR))* 12+ now.get(Calendar.MONTH)
                    - born.get(Calendar.MONTH);
        }
        return age;
    }
}
