package com.Jason.tools.captcha;
...
public class CaptchaTools
{
    ...
    public CaptchaTools(int width, int height) {
        this.width = width;
        this.height = height;
        creatImage();
    }

    public CaptchaTools(int width, int height, int codeCount) {
        this.width = width;
        this.height = height;
    ...
    public CaptchaTools(int width, int height, int codeCount, int lineCount) {
        this.width = width;
        this.height = height;
        this.codeCount = codeCount;
...
//		// 自定义参数
//		CaptchaTools code = new CaptchaTools(width, height, codeCount, lineCount);
