...
import com.Jason.tools.validate.ValidateTools;
...
public class StringTools
{
     ...
     * 截取
     * @param srcStr 原始字符串
     * @param charLength 从最后一位开始向前查询的
     * @return
     */
    public static String retainMantissa(String srcStr,int charLength)
    {
        char[] strCharArray = srcStr.toCharArray();
        StringBuffer buffer = new StringBuffer();
        int splitIndex = strCharArray.length - charLength;
    ...
    {
        System.out.println(retainMantissa("370827199405212510",6));
    }*/
}
