package com.Jason.tools.file;

import com.Jason.tools.date.DateTools;
import com.Jason.tools.random.RandomTools;
...
public class FileTools {
    ...
    public static String getFileName(String type,String prefix,String suffix){
        ...
        String random = RandomTools.generateNumberString(10);   //10位随机数
